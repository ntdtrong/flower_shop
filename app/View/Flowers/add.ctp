			...
			?>
		  	...
		  	<form role="form" enctype='multipart/form-data' action="/flowers/add" method="post">
		  		<div class="form-group">
		  			<label for="txtCategory">Danh mục</label>
			  		<select name="category" id="txtCategory" class="form-control">
					  <?php  
                		if(!empty($data['categories'])){
							...
							?>
							<option value="<?php echo $cate['Category']['id'];?>" <?php echo (intval($cate['Category']['id']) === $selectId)? 'selected="selected"':''; ?> ><?php echo $cate['Category']['name'];?></option>
							<?php 
							}	
                		}	
                		?>
